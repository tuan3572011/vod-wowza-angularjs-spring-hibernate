	...
	function loadVideo() {
		$(document)
				.ready(
						function() {
							//$("#video").remove();
							var source = '<video width="930" height="500" controls="controls"  id="video" class="video-js vjs-default-skin" >';
							source = source
									+ '<source src="http://52.74.51.146:1935/vod-project/Microsoft/playlist.m3u8" type="application/x-mpegurl" id="videoSource" />  </video>';
							source = source + "";
							source = source.replace("Microsoft", sessionStorage
									.getItem("source"));
