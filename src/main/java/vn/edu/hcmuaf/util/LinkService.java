...
public class LinkService {
    ...
    public static final String RELATED_MOVIES = DOMAIN
            + "/film/relatedMovies/{filmId}";
    public static final String SEARCH_FILM = DOMAIN
            + "/search/{searchData}/all";
    public static final String SEARCH_FILM_BY_STARRING = DOMAIN
            + "/search/{searchData}/starring";
    public static final String SEARCH_FILM_BY_DIRECTOR = DOMAIN
            + "/search/{searchData}/director";
    ...
    public static final String DERIE_DELETE = DOMAIN
            + "/serie/delete/{serieId}";
    public static final String SERIE_UPDATE = DOMAIN + "/serie/update";

    // Episode
    public static final String EPISODE_GETBY_ID = DOMAIN
            + "/episode/get/{epId}";
    public static final String EPISODE_GETALL = DOMAIN + "/episode/all";
    public static final String EPISODE_ADD = DOMAIN + "/episode/add";
    public static final String EPISODE_GETBY_SERIE = DOMAIN
            + "/episode/getBySerie/{serieId}/{noEpisode}";
    public static final String EPISODE_UPDATE = DOMAIN + "/episode/update";
    public static final String EPISODE_GET_LIST_BY_SERIE = DOMAIN
            + "/episode/getListBySerie/{serieId}";

    // User
    public static final String USER_GETBY_EMAIL = DOMAIN
            + "/user/get/{email}/login";
    ...
    // Register Film
    public static final String REGIS_ADD = DOMAIN
            + "/regis/addregis/{email}/{idFilm}/{type}";
    public static final String REGIS_GETBY_ID = DOMAIN
            + "/regis/getById/{regisId}";
    public static final String REGIS_GETBY_EMAIL = DOMAIN
            + "/regis/getListByUser/{email}/user";
    public static final String REGIS_GETBY_EMAIL_IDFILM = DOMAIN
            + "/regis/getRegis/{email}/{idFilm}";

    // Re charge
    public static final String RECHARGE_ADD = DOMAIN
            + "/recharge/add/{email}/{seri}";
    public static final String RECHARGE_UPDATE = DOMAIN + "/recharge/update";
    public static final String RECHARGE_GETBY_ID = DOMAIN
            + "/recharge/getById/{rechargeId}";
    public static final String RECHARGE_GETBY_USER = DOMAIN
            + "/recharge/getByUser/{email}/user";

    // Comment
    public static final String COMMENT_ADD = DOMAIN + "/comment/add";
    public static final String COMMENT_GETBY_ID = DOMAIN
            + "/comment/getById/{commentId}";
    public static final String COMMENT_GETBY_USER = DOMAIN
            + "/comment/getByUser/{email}/user";
    public static final String COMMENT_GETBY_MOVIE = DOMAIN
            + "/comment/getByFilm/{filmId}";

    // Starring
    public static final String STAR_GETBY_ID = DOMAIN
            + "/starring/get/{starId}";
    ...
    public static final String DIRECTOR_GETBY_ID = DOMAIN
            + "/director/get/{directorId}";
    ...
    public static final String COUNTRY_GETBY_ID = DOMAIN
    ...
    public static final String CATE_GETBY_ID = DOMAIN
            + "/category/get/{cateId}";
    public static final String CATE_GETALL = DOMAIN + "/category/all";

    // MovieOdd
    public static final String MOVIEODD_GETALL = DOMAIN + "/movieodd/all";
    public static final String MOVIEODD_GETBY_VIEW = DOMAIN
            + "/movieodd/getByView";
    public static final String MOVIEODD_GETBY_RATE = DOMAIN
            + "/movieodd/getByRate";
    public static final String MOVIEODD_GETBY_ID = DOMAIN
            + "/movieodd/get/{movieId}";
    ...
    public static final String CARD_GETBY_ID = DOMAIN
            + "/card/getById/{cardId}";
    public static final String CARD_GETBY_SERI = DOMAIN
            + "/card/getBySeri/{seri}";
    public static final String CARD_ADD = DOMAIN + "/card/add/{value}";

    // Additional
    // MOVIE
    public static final String MOVIE_GETBY_CATEGORY = DOMAIN
            + "/movie/getByCategory/{cateId}";
    public static final String MOVIE_GETBY_COUNTRY = DOMAIN
            + "/movie/getByCountry/{countryId}";
    public static final String MOVIE_GETBY_YEAR = DOMAIN
            + "/movie/getByYear/{year}";
    ...
    // SERIE
    public static final String SERIE_GETBY_CATEGORY = DOMAIN
            + "/serie/getByCategory/{cateId}";
    public static final String SERIE_GETBY_COUNTRY = DOMAIN
            + "/serie/getByCountry/{countryId}";
    public static final String SERIE_GETBY_YEAR = DOMAIN
            + "/serie/getByYear/{year}";
